...
@section('title')
<title>BLOGS | THINK VIVACIOUS</title>
...
<section class="pb-5">
    ...
    <div class="row">
        <div class="col-lg-9 mb-5 mb-lg-0">
            ...
            <div class="col-lg-6"><a class="d-block mb-4" href="{{route('blog.show',str_replace(' ', '_',$blog->title))}}">
            ...
            <h2 class="h3 mb-4"> <a class="d-block reset-anchor" href="{{route('blog.show',str_replace(' ', '_',$blog->title))}}">{{$blog->title}}</a></h2>
            <p class="text-muted">{!! substr( $blog->description, 0, 230) !!}....</p>
            <a class="btn btn-link p-0 read-more-btn" href="{{route('blog.show',str_replace(' ', '_',$blog->title))}}"><span>Read more</span><i class="fas fa-long-arrow-alt-right"></i></a>
            </div>
        </div>
        @endforeach
