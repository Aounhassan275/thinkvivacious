                    ...
                    <div class="col-lg-8 col-12 mx-auto">
                        <form action="{{route('admin.information.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="about" id="" cols="30" rows="2" class="form-control"></textarea>                                        
                            </div>       
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="hdescription" id="" cols="30" rows="2" class="form-control"></textarea>                                        
                            </div>  
                            <div class="form-group">
                                <label>Enter Blog Category Meta Description</label>
                                <textarea name="bcdescription" id="" cols="30" rows="2" class="form-control"></textarea>                                        
                            </div> 
                            <div class="form-group">
                                <label>Enter Contact Us Meta Description</label>
                                <textarea name="cdescription" id="" cols="30" rows="2" class="form-control"></textarea>                                        
                                </div>
                            <div class="form-group">
                                <label>Enter About Us Meta Description</label>
                                <textarea name="adescription" id="" cols="30" rows="2" class="form-control"></textarea>                                        
                            </div>
                            <div class="form-group">
                                <label>Enter Privacy Policy Meta Description</label>
                                <textarea name="pdescription" id="" cols="30" rows="2" class="form-control"></textarea>                                        
                            </div>     
                            <div class="form-group">
                                <label>Enter Facebook Link</label>
                                <input type="text" name="fb" placeholder="Enter Facebook Link" class="form-control" required>
                            </div>  
                            <div class="form-group">
                                <label>Enter Instagram Link</label>
                                <input type="text" name="insta" placeholder="Enter Instagram Link" class="form-control" required>
                            </div>  
                            <div class="form-group">
                                <label>Enter Twitter Link</label>
                                <input type="text" name="twitter" placeholder="Enter Twitter Link" class="form-control" required>
                            </div>  
                            
                            <div class="form-group">
                                <label>Enter Pinterest Link</label>
                                <input type="text" name="pt" placeholder="Enter Pinterest Link" class="form-control" required>
                            </div>  
                            <div class="form-group">
