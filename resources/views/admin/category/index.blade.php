                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                          ...
                          <div class="form-group col-md-12">
                            ...
                            <input name="image" type="file" class="form-control" placeholder="Enter Category Name" required>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input class="form-control" type="file" id="image" name="image" placeholder="Enter name" required>
                    </div>
                </div>
